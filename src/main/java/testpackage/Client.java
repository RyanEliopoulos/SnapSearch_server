...
public class Client {
  // Basic client used for debugging the server.
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      while (true) { // Input parse loop
        String inputstring = scanner.next();
        if (inputstring.charAt(0) == 'Q') { // Quit command
          System.out.println("User shutdown request");
          outstream.write((byte) 'Q');
          break;
        } else if (inputstring.charAt(0) == 'D') { // Data connection command
        ...
        } else if (inputstring.charAt(0) == 'P') { // Downloading photo command
...
<<<<<<< HEAD
        ...
        } else if (inputstring.charAt(0) == 'U') { // Upload photo command
...
>>>>>>> parent of 2198149 (changed two float - lat/long to doubles)
